...
const DashboardHome = () => {
  ...
  const [selectedOrder, setSelectedOrder] = useState(null); // change
  ...
  const handleOpenModal = (orderId) => { // change and at last OrderDetail componentent
      ...
      <main className="col-lg-9">
        ...
        <section className="card border-0 shadow-sm">
          <div className="card-header bg-white py-3 d-flex justify-content-between align-items-center border-bottom-0">
            ...
            <Link className="btn btn-link text-decoration-none btn-sm" to='/dashboard/orders' >
              View All
            </Link>
          </div>
                    ...
                    return (
                      <tr key={order.id}>
                        ...
                        <td className="text-end pe-4">
                          <button className="btn btn-sm btn-light border" onClick={() => handleOpenModal(order?.id)} >
                            Details
                          </button>
                        </td>
                      </tr>
