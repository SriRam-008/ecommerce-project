                ...
                <div className="card-body text-center py-4">
                  <div className="mb-4">
                    ...
                    <p className="mt-2 text-muted">
                      This is a demo application created for learning purposes. Payment methods are simulated. Kindly click “Place Order” to proceed.
                    </p>
                  </div>
            ...
            <div className="card sticky-top" style={{ top: "100px" }}>
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between mb-3">
                  <span>Tax:</span>
                  <span>₹{(cartState?.total - cartState?.subtotal).toFixed(2)}</span>
                </div>
                <hr />
                <div className="d-flex justify-content-between mb-3">
                  <strong>Total:</strong>
